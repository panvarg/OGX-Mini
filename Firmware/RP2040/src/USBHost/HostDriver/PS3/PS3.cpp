...
void PS3Device::process(const uint8_t idx, Gamepad& gamepad)
{
    if (gamepad.new_pad_in())
    {
        ...
        // FIX 2: L2/R2 analog axis (0-255) - było brakujące, triggery wychodziły 0/255 zamiast płynnie
        ...
        else
        {
            ...
            // FIX 3: zamienione przyciski - circle<-B, cross<-A, square<-X
